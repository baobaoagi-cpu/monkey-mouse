...
public class HydraConfig
{
    ...
    public bool SyncScreensaver { get; init; } = false;
    public bool EnableFileTransfer { get; init; } = false;
    // Local consent for both sending and receiving lock commands (including hotkeys).
    public bool AllowRemoteLock { get; init; } = false;
    public bool AllowRemoteWake { get; init; } = false;
