...
public interface IHydraProfile
{
    ...
    bool AllowRemoteLock { get; }
    bool AllowRemoteWake { get; }
...
public class HydraProfile(HydraConfigFile configFile, HydraConfig? activeProfile, string? networkConfigOverride = null) : IHydraProfile
{
    ...
    public bool SyncScreensaver => _activeProfile?.SyncScreensaver ?? false;
    public bool EnableFileTransfer => _activeProfile?.EnableFileTransfer ?? false;
    public bool AllowRemoteLock => _activeProfile?.AllowRemoteLock ?? false;
    public bool AllowRemoteWake => _activeProfile?.AllowRemoteWake ?? false;
