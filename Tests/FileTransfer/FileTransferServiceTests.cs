...
public class FileTransferServiceTests
{
    ...
    public void SetUp()
    {
        ...
        _service = new FileTransferService(_dialog, new FakeDropTargetResolver(_tempRoot), NullLogger<FileTransferService>.Instance, enableFileTransfer: true);
    }
    ...
    private FileTransferService FastTimeoutService() =>
        new(_dialog, new FakeDropTargetResolver(_tempRoot), NullLogger<FileTransferService>.Instance, watchdogTimeoutMs: 100, enableFileTransfer: true);
    ...
    {
        using var service = new FileTransferService(_dialog, new NullDropTargetResolver(), NullLogger<FileTransferService>.Instance, enableFileTransfer: true);
    ...
    public async Task FullReceiveFlow_HashMatch_ShowsCompleted()
    {
        ...
        using var service = new FileTransferService(_dialog, new FakeDropTargetResolver(destDir), NullLogger<FileTransferService>.Instance, enableFileTransfer: true);
